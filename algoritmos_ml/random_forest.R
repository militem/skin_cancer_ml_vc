...
modelo = randomForest(as.factor(y)~., data=training_set, proximity=TRUE)

plot(modelo)
legend("topright",colnames(modelo$err.rate),col=1:4,cex=0.4,fill=1:4)
